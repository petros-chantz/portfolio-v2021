  ...
  return (
    <Container gap="70px" place="center">
      <TextLarge>
        ...
        University of Eindhoven. Currently I’m passionate about frontend
        development technologies such as React.js and with emphasis on the use
        of data as a design material.
      </TextLarge>
