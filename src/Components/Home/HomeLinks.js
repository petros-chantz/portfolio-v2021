...
export default function HomeLinks(){
    ...
    return(
        <HomeLinksWrapper>     
            ...
            <div><animated.a style={props} href="./assets/pdf/Petros-Chantzopoulos-CV.pdf" type="application/pdf" target="_blank" rel="external" className="links">cv</animated.a></div>
