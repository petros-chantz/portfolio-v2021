...
export default function HomeLinks(){
    ...
    return(
        <HomeLinksWrapper>     
            ...
            <div><animated.a style={props} href="https://www.dropbox.com/s/m50fy9t5g6536u2/Petros-Chantzopoulos-CV.pdf?dl=0" type="application/pdf" target="_blank" rel="external" className="links">cv</animated.a></div>
